...
function initializePcodedMenu() {
    // Call the existing initialization logic from pcoded.js
    if (typeof $ !== 'undefined') {
        $("#pcoded").pcodedmenu({
            MenuTrigger: 'click',
            SubMenuTrigger: 'click',
...
function initializePerfectScrollbar(selector) {
    if (typeof PerfectScrollbar !== 'undefined' && document.querySelector('.' + selector)) {
...
// Use event delegation for mobile collapse buttons (works with Blazor dynamic rendering)
$(document).on('click', '#mobile-collapse, #mobile-collapse1', function(e) {
    ...
    console.log('Mobile collapse clicked - viewport width:', vw);
});

// Also handle .mobile-menu with event delegation
$(document).on('click', '.mobile-menu', function(e) {
    ...
    $(this).toggleClass('on');
    $(".pcoded-navbar").toggleClass('mob-open');
    $("#mobile-collapse, #mobile-collapse1").toggleClass('on');
});