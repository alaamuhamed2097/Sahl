...
function initializeDashboard() {
    ...
    // Initialize todo list checkboxes
    ...
    // Initialize PerfectScrollbar for various containers
...
function initializePcodedMenu() {
    // Initialize the pcoded menu system
    $("#pcoded").pcodedmenu({
        MenuTrigger: 'click',
        SubMenuTrigger: 'click',
    });
...
function setActiveMenuItems() {
    ...
    $(".pcoded-navbar .pcoded-inner-navbar li").removeClass("active pcoded-trigger");
    
    // Get current path without query string
    var pageUrl = window.location.href.split(/[?#]/)[0];
    var path = new URL(pageUrl).pathname;
    
    // Find matching links and set active state
    $(".pcoded-navbar .pcoded-inner-navbar a").each(function() {
        ...
        if (href && path.endsWith(href)) {
            ...
            $(this).parents('.pcoded-hasmenu').addClass("active pcoded-trigger");
            $(this).parents('.pcoded-submenu').css('display', 'block');
        }
    });
}
...
window.ensureMenuInitialized = function() {
    initializePcodedMenu();
};
