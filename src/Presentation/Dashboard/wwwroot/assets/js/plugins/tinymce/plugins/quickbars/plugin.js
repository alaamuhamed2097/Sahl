...
(function (domGlobals) {
    ...
    var setupButtons = function (editor) {
      editor.Dashboard.registry.addButton('quickimage', {
        icon: 'image',
      ...
      editor.Dashboard.registry.addButton('quicktable', {
        icon: 'table',
    ...
    var addToEditor = function (editor) {
      ...
      if (insertToolbarItems.trim().length > 0) {
        editor.Dashboard.registry.addContextToolbar('quickblock', {
    ...
    var addToEditor$1 = function (editor) {
      ...
      if (imageToolbarItems.trim().length > 0) {
        editor.Dashboard.registry.addContextToolbar('imageselection', {
          predicate: isImage,
      ...
      if (textToolbarItems.trim().length > 0) {
        editor.Dashboard.registry.addContextToolbar('textselection', {
          predicate: function (node) {
