...
(function (domGlobals) {
    ...
    var register$1 = function (editor) {
      ...
      editor.Dashboard.registry.addButton('rotateleft', {
        tooltip: 'Rotate counterclockwise',
        icon: 'rotate-left',
        onAction: cmd('mceImageRotateLeft')
      });
      editor.Dashboard.registry.addButton('rotateright', {
        tooltip: 'Rotate clockwise',
        icon: 'rotate-right',
        onAction: cmd('mceImageRotateRight')
      });
      editor.Dashboard.registry.addButton('flipv', {
        tooltip: 'Flip vertically',
        icon: 'flip-vertically',
        onAction: cmd('mceImageFlipVertical')
      });
      editor.Dashboard.registry.addButton('fliph', {
        tooltip: 'Flip horizontally',
        icon: 'flip-horizontally',
        onAction: cmd('mceImageFlipHorizontal')
      });
      editor.Dashboard.registry.addButton('editimage', {
        tooltip: 'Edit image',
        icon: 'edit-image',
      ...
      editor.Dashboard.registry.addButton('imageoptions', {
        tooltip: 'Image options',
        icon: 'image-options',
        onAction: cmd('mceImage')
      });
      editor.Dashboard.registry.addContextMenu('imagetools', {
    ...
    var register$2 = function (editor) {
      editor.Dashboard.registry.addContextToolbar('imagetools', {
