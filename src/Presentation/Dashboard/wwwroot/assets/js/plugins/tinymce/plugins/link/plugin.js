...
(function (domGlobals) {
    ...
    var setupMenuItems = function (editor) {
      editor.Dashboard.registry.addMenuItem('openlink', {
        text: 'Open link',
        icon: 'new-tab',
        onAction: Actions.gotoSelectedLink(editor),
        onSetup: Actions.toggleEnabledState(editor)
      });
      editor.Dashboard.registry.addMenuItem('link', {
        icon: 'link',
        text: 'Link...',
        shortcut: 'Meta+K',
        onAction: Actions.openDialog(editor)
      });
      editor.Dashboard.registry.addMenuItem('unlink', {
        icon: 'unlink',
        text: 'Remove link',
        onAction: function () {
          return Utils.unlink(editor);
    ...
    var setupContextMenu = function (editor) {
      ...
      var noLink = 'link';
      editor.Dashboard.registry.addContextMenu('link', {
    ...
    var setupContextToolbars = function (editor) {
      ...
      editor.Dashboard.registry.addContextForm('quicklink', {
        launch: {
