...
(function (domGlobals) {
    ...
    var register$1 = function (editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState) {
      ...
      if (languageMenuItems.length > 1) {
        editor.Dashboard.registry.addSplitButton('spellchecker', splitButtonArgs);
      } else {
        editor.Dashboard.registry.addToggleButton('spellchecker', buttonArgs);
      }
      editor.Dashboard.registry.addToggleMenuItem('spellchecker', {
        text: 'Spellcheck',
    ...
    var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState) {
      ...
      editor.Dashboard.registry.addContextMenu('spellchecker', { update: update });
    };
