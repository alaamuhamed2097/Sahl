...
(function () {
    ...
    var register$1 = function (editor) {
      editor.Dashboard.registry.addButton('toc', {
        icon: 'toc',
      ...
      editor.Dashboard.registry.addButton('tocupdate', {
        icon: 'reload',
        tooltip: 'Update',
        onAction: function () {
      ...
      editor.Dashboard.registry.addMenuItem('toc', {
        icon: 'toc',
      ...
      editor.Dashboard.registry.addContextToolbar('toc', {
        items: 'tocupdate',
