...
function () {
  ...
  _createClass(Context, [{
    ...
    value: function initialize() {
      this.layoutInfo = this.Dashboard.createLayout(this.$note);
    ...
    value: function destroy() {
      ...
      this.Dashboard.removeLayout(this.$note, this.layoutInfo);
    }
    /**
...
function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function button(o) {
      ...
      return this.Dashboard.button(o);
    }
  }, {
    key: "initialize",
    value: function initialize() {
    ...
    value: function colorPalette(className, tooltip, backColor, foreColor) {
      ...
      return this.Dashboard.buttonGroup({
        className: 'note-color ' + className,
        children: [this.button({
          className: 'note-current-color-button',
          contents: this.Dashboard.icon(this.options.icons.font + ' note-recent-color'),
          tooltip: tooltip,
          ...
          contents: this.Dashboard.dropdownButtonContents('', this.options),
          tooltip: this.lang.color.more,
          data: {
            toggle: 'dropdown'
          }
        }), this.Dashboard.dropdown({
          ...
          callback: function callback($dropdown) {
            $dropdown.find('.note-holder').each(function (idx, item) {
              ...
              $holder.append(_this.Dashboard.palette({
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.style', function () {
        return _this2.Dashboard.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.Dashboard.dropdownButtonContents(_this2.Dashboard.icon(_this2.options.icons.magic), _this2.options),
          tooltip: _this2.lang.style.style,
          data: {
            toggle: 'dropdown'
          }
        }), _this2.Dashboard.dropdown({
      ...
      this.context.memo('button.bold', function () {
        return _this2.button({
          ...
          contents: _this2.Dashboard.icon(_this2.options.icons.bold),
      ...
      this.context.memo('button.italic', function () {
        return _this2.button({
          ...
          contents: _this2.Dashboard.icon(_this2.options.icons.italic),
      ...
      this.context.memo('button.underline', function () {
        return _this2.button({
          ...
          contents: _this2.Dashboard.icon(_this2.options.icons.underline),
      ...
      this.context.memo('button.clear', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.eraser),
      ...
      this.context.memo('button.strikethrough', function () {
        return _this2.button({
          ...
          contents: _this2.Dashboard.icon(_this2.options.icons.strikethrough),
      ...
      this.context.memo('button.superscript', function () {
        return _this2.button({
          ...
          contents: _this2.Dashboard.icon(_this2.options.icons.superscript),
      ...
      this.context.memo('button.subscript', function () {
        return _this2.button({
          ...
          contents: _this2.Dashboard.icon(_this2.options.icons.subscript),
      ...
      this.context.memo('button.fontname', function () {
        ...
        return _this2.Dashboard.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.Dashboard.dropdownButtonContents('<span class="note-current-fontname"/>', _this2.options),
          tooltip: _this2.lang.font.name,
          data: {
            toggle: 'dropdown'
          }
        }), _this2.Dashboard.dropdownCheck({
      ...
      this.context.memo('button.fontsize', function () {
        return _this2.Dashboard.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.Dashboard.dropdownButtonContents('<span class="note-current-fontsize"/>', _this2.options),
      ...
      this.context.memo('button.fontsizeunit', function () {
        return _this2.Dashboard.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.Dashboard.dropdownButtonContents('<span class="note-current-fontsizeunit"/>', _this2.options),
      ...
      this.context.memo('button.ul', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.unorderedlist),
      ...
      this.context.memo('button.ol', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.orderedlist),
          tooltip: _this2.lang.lists.ordered + _this2.representShortcut('insertOrderedList'),
          click: _this2.context.createInvokeHandler('editor.insertOrderedList')
        }).render();
      });
      var justifyLeft = this.button({
        contents: this.Dashboard.icon(this.options.icons.alignLeft),
        tooltip: this.lang.paragraph.left + this.representShortcut('justifyLeft'),
        click: this.context.createInvokeHandler('editor.justifyLeft')
      });
      var justifyCenter = this.button({
        contents: this.Dashboard.icon(this.options.icons.alignCenter),
        tooltip: this.lang.paragraph.center + this.representShortcut('justifyCenter'),
        click: this.context.createInvokeHandler('editor.justifyCenter')
      });
      var justifyRight = this.button({
        contents: this.Dashboard.icon(this.options.icons.alignRight),
        tooltip: this.lang.paragraph.right + this.representShortcut('justifyRight'),
        click: this.context.createInvokeHandler('editor.justifyRight')
      });
      var justifyFull = this.button({
        contents: this.Dashboard.icon(this.options.icons.alignJustify),
        tooltip: this.lang.paragraph.justify + this.representShortcut('justifyFull'),
        click: this.context.createInvokeHandler('editor.justifyFull')
      });
      var outdent = this.button({
        contents: this.Dashboard.icon(this.options.icons.outdent),
        tooltip: this.lang.paragraph.outdent + this.representShortcut('outdent'),
        click: this.context.createInvokeHandler('editor.outdent')
      });
      var indent = this.button({
        contents: this.Dashboard.icon(this.options.icons.indent),
      ...
      this.context.memo('button.paragraph', function () {
        return _this2.Dashboard.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.Dashboard.dropdownButtonContents(_this2.Dashboard.icon(_this2.options.icons.alignLeft), _this2.options),
          tooltip: _this2.lang.paragraph.paragraph,
          data: {
            toggle: 'dropdown'
          }
        }), _this2.Dashboard.dropdown([_this2.Dashboard.buttonGroup({
          className: 'note-align',
          children: [justifyLeft, justifyCenter, justifyRight, justifyFull]
        }), _this2.Dashboard.buttonGroup({
          className: 'note-list',
      ...
      this.context.memo('button.height', function () {
        return _this2.Dashboard.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.Dashboard.dropdownButtonContents(_this2.Dashboard.icon(_this2.options.icons.textHeight), _this2.options),
      ...
      this.context.memo('button.table', function () {
        return _this2.Dashboard.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.Dashboard.dropdownButtonContents(_this2.Dashboard.icon(_this2.options.icons.table), _this2.options),
      ...
      this.context.memo('button.link', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.link),
      ...
      this.context.memo('button.picture', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.picture),
      ...
      this.context.memo('button.video', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.video),
      ...
      this.context.memo('button.hr', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.minus),
      ...
      this.context.memo('button.fullscreen', function () {
        return _this2.button({
          ...
          contents: _this2.Dashboard.icon(_this2.options.icons.arrowsAlt),
      ...
      this.context.memo('button.codeview', function () {
        return _this2.button({
          ...
          contents: _this2.Dashboard.icon(_this2.options.icons.code),
      ...
      this.context.memo('button.redo', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.redo),
      ...
      this.context.memo('button.undo', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.undo),
      ...
      this.context.memo('button.help', function () {
        return _this2.button({
          contents: _this2.Dashboard.icon(_this2.options.icons.question),
    ...
    value: function addImagePopoverButtons() {
      ...
      this.context.memo('button.resizeNone', function () {
        return _this3.button({
          contents: _this3.Dashboard.icon(_this3.options.icons.rollback),
      ...
      this.context.memo('button.floatLeft', function () {
        return _this3.button({
          contents: _this3.Dashboard.icon(_this3.options.icons.floatLeft),
      ...
      this.context.memo('button.floatRight', function () {
        return _this3.button({
          contents: _this3.Dashboard.icon(_this3.options.icons.floatRight),
      ...
      this.context.memo('button.removeMedia', function () {
        return _this3.button({
          contents: _this3.Dashboard.icon(_this3.options.icons.trash),
    ...
    value: function addLinkPopoverButtons() {
      ...
      this.context.memo('button.linkDialogShow', function () {
        return _this4.button({
          contents: _this4.Dashboard.icon(_this4.options.icons.link),
      ...
      this.context.memo('button.unlink', function () {
        return _this4.button({
          contents: _this4.Dashboard.icon(_this4.options.icons.unlink),
    ...
    value: function addTablePopoverButtons() {
      ...
      this.context.memo('button.addRowUp', function () {
        return _this5.button({
          className: 'btn-md',
          contents: _this5.Dashboard.icon(_this5.options.icons.rowAbove),
      ...
      this.context.memo('button.addRowDown', function () {
        return _this5.button({
          className: 'btn-md',
          contents: _this5.Dashboard.icon(_this5.options.icons.rowBelow),
      ...
      this.context.memo('button.addColLeft', function () {
        return _this5.button({
          className: 'btn-md',
          contents: _this5.Dashboard.icon(_this5.options.icons.colBefore),
      ...
      this.context.memo('button.addColRight', function () {
        return _this5.button({
          className: 'btn-md',
          contents: _this5.Dashboard.icon(_this5.options.icons.colAfter),
      ...
      this.context.memo('button.deleteRow', function () {
        return _this5.button({
          className: 'btn-md',
          contents: _this5.Dashboard.icon(_this5.options.icons.rowRemove),
      ...
      this.context.memo('button.deleteCol', function () {
        return _this5.button({
          className: 'btn-md',
          contents: _this5.Dashboard.icon(_this5.options.icons.colRemove),
      ...
      this.context.memo('button.deleteTable', function () {
        return _this5.button({
          className: 'btn-md',
          contents: _this5.Dashboard.icon(_this5.options.icons.trash),
    ...
    value: function build($container, groups) {
      for (var groupIdx = 0, groupLen = groups.length; groupIdx < groupLen; groupIdx++) {
        ...
        var $group = this.Dashboard.buttonGroup({
    ...
    value: function updateBtnStates($container, infos) {
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(infos, function (selector, pred) {
        _this7.Dashboard.toggleBtnActive($container.find(selector), pred());
      });
    }
  }, {
...
function () {
  ...
  Toolbar_createClass(Toolbar, [{
    ...
    value: function updateFullscreen(isFullscreen) {
      this.Dashboard.toggleBtnActive(this.$toolbar.find('.btn-fullscreen'), isFullscreen);
      this.changeContainer(isFullscreen);
    }
  }, {
    key: "updateCodeview",
    value: function updateCodeview(isCodeview) {
      this.Dashboard.toggleBtnActive(this.$toolbar.find('.btn-codeview'), isCodeview);
    ...
    value: function activate(isIncludeCodeview) {
      ...
      this.Dashboard.toggleBtn($btn, true);
    }
  }, {
    key: "deactivate",
    value: function deactivate(isIncludeCodeview) {
      ...
      this.Dashboard.toggleBtn($btn, false);
    }
  }]);
...
function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var body = ['<div class="form-group note-form-group">', "<label for=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.textToDisplay, "</label>"), "<input id=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-link-text form-control note-form-control note-input\" type=\"text\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.url, "</label>"), "<input id=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-link-url form-control note-form-control note-input\" type=\"text\" value=\"http://\"/>"), '</div>', !this.options.disableLinkTarget ? external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.Dashboard.checkbox({
        className: 'sn-checkbox-open-in-new-window',
        text: this.lang.link.openInNewWindow,
        checked: true
      }).render()).html() : '', external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.Dashboard.checkbox({
      ...
      this.$dialog = this.Dashboard.dialog({
    ...
    key: "destroy",
    value: function destroy() {
      this.Dashboard.hideDialog(this.$dialog);
      this.$dialog.remove();
    }
  }, {
    key: "bindEnterKey",
    ...
    value: function toggleLinkBtn($linkBtn, $linkText, $linkUrl) {
      this.Dashboard.toggleBtn($linkBtn, $linkText.val() && $linkUrl.val());
    }
    /**
    ...
    value: function showLinkDialog(linkInfo) {
      ...
      return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
        ...
        _this.Dashboard.onDialogShown(_this.$dialog, function () {
          ...
          $linkBtn.one('click', function (event) {
            ...
            _this.Dashboard.hideDialog(_this.$dialog);
          });
        });

        _this.Dashboard.onDialogHidden(_this.$dialog, function () {
          // detach events
          $linkText.off();
          $linkUrl.off();
          $linkBtn.off();
        ...
        _this.Dashboard.showDialog(_this.$dialog);
      }).promise();
    }
    /**
...
function () {
  ...
  LinkPopover_createClass(LinkPopover, [{
    ...
    key: "initialize",
    value: function initialize() {
      this.$popover = this.Dashboard.popover({
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function showImageDialog() {
      ...
      return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
        ...
        _this2.Dashboard.onDialogShown(_this2.$dialog, function () {
          ...
          $imageUrl.on('input paste propertychange', function () {
            _this2.Dashboard.toggleBtn($imageBtn, $imageUrl.val());
          }).val('');
        ...
        _this2.Dashboard.onDialogHidden(_this2.$dialog, function () {
          $imageInput.off();
          $imageUrl.off();
          $imageBtn.off();
        ...
        _this2.Dashboard.showDialog(_this2.$dialog);
      });
    }
  }]);
      ...
      return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
        ...
        _this2.Dashboard.onDialogShown(_this2.$dialog, function () {
          ...
          $videoUrl.on('input paste propertychange', function () {
            _this2.Dashboard.toggleBtn($videoBtn, $videoUrl.val());
          });
...
// CONCATENATED MODULE: ./src/js/bs4/Dashboard.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
