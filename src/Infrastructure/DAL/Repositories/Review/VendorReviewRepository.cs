...
namespace DAL.Repositories.Review
{
	...
	{
		public VendorReviewRepository(ApplicationDbContext dbContext, ICurrentUserService currentUserService, ILogger logger)
	 ...
	 CancellationToken cancellationToken = default)
		...
		public async Task<(List<TbVendorReview> Items, int TotalRecords)> GetPagedReviewsWithDetailsAsync(
		int pageNumber,
		int pageSize,
