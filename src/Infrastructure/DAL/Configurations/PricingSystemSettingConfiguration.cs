        ...
        public void Configure(EntityTypeBuilder<TbPricingSystemSetting> entity)
        {
            ...
            entity.HasData(
                new TbPricingSystemSetting
                {
                    ...
                    SystemType = Common.Enumerations.Pricing.PricingStrategyType.Simple,
                    IsEnabled = true,
                    DisplayOrder = 1,
                    IsDeleted = false,
                ...
                new TbPricingSystemSetting
                {
                    ...
                    SystemType = Common.Enumerations.Pricing.PricingStrategyType.CombinationBased,
                    IsEnabled = true,
                    DisplayOrder = 2,
                    IsDeleted = false,
                    CreatedBy = Guid.Parse("00000000-0000-0000-0000-000000000001"),
                ...
                new TbPricingSystemSetting
                {
                    ...
                    SystemType = Common.Enumerations.Pricing.PricingStrategyType.QuantityBased,
                    IsEnabled = true,
                    DisplayOrder = 3,
                    IsDeleted = false,
                    CreatedBy = Guid.Parse("00000000-0000-0000-0000-000000000001"),
                ...
                new TbPricingSystemSetting
                {
                    ...
                    SystemType = Common.Enumerations.Pricing.PricingStrategyType.Hybrid,
                    IsEnabled = true,
                    DisplayOrder = 4,
                    IsDeleted = false,
                    CreatedBy = Guid.Parse("00000000-0000-0000-0000-000000000001"),
