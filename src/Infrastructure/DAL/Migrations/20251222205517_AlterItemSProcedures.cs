...
{
    /// <inheritdoc />
    public partial class AlterItemSProcedures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Alter stored procedure: SpGetItemDetails
...
BEGIN
    ...
    SELECT 
        ...
        ELSE NULL END AS CurrentCombinationJson,
...
GO
");
            // Alter stored procedure: SpGetAvailableSearchFilters
