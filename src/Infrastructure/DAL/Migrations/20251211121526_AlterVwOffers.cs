...
{
    /// <inheritdoc />
    public partial class AlterVwOffers : Migration
    {
        /// <inheritdoc />
        ...
        (
            SELECT 
				...
				(
					...
					icimg.Path,
					icimg.[Order],
					icimg.ItemCombinationId
					FROM dbo.TbItemCombinationImages icimg
					WHERE icimg.ItemCombinationId = ic.Id AND icimg.IsDeleted = 0 
					ORDER BY 
						icimg.[Order]
					FOR JSON PATH
				 ),
