...
{
    public class CountryService : BaseService<TbCountry, CountryDto>, ICountryService
    {
        private readonly ITableRepository<TbCountry> _baseRepository;
        private readonly IBaseMapper _mapper;

        public CountryService(ITableRepository<TbCountry> baseRepository, IBaseMapper mapper)
        ...
        public PaginatedDataModel<CountryDto> GetPage(BaseSearchCriteriaModel criteriaModel)
        {
